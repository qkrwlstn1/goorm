class UI{
    ...
    showProfile(user) {
        ...
        <div class="card card-body mb-3">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <span class="badge badge-secondary">Public Fists: ${user.public_gists}</span>
        ...
        <h3 class="page-heading mb-3"> Latest Repos3</h3>
        <div id="repos"></div>
        `;    
    }
                ...
                <div class="card card-body mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="badge badge-success"> ${repo.forms_count}</span>
                        </div>
                    </div>
                </div>
            `;
